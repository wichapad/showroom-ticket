            ...
            <div className="text-white sm:grid sm:grid-cols-2 sm:gap-4 md:flex justify-around lg:flex lg:justify-between max-w-screen-lg mx-auto">
                <div className="w-48">
                    ...
                    <div className="mt-4 text-sm text-gray-300">
                        <p>553/2,Ramintra ,Tha Raeng, Bang Khen, Bangkok, Thailand 32105 </p>
                ...
                <div className="flex flex-col">
                    <div className="flex w-6 h-6 ">
                        <img className="mr-2" src="https://cdn-icons-png.flaticon.com/128/4494/4494475.png" alt="" />
                        <img className="mr-2" src="https://cdn-icons-png.flaticon.com/128/3670/3670089.png" alt="" />
                        <img className="mr-2" src="https://cdn-icons-png.flaticon.com/128/4494/4494488.png" alt="" />
                        <img className="mr-2" src="https://cdn-icons-png.flaticon.com/128/4494/4494477.png" alt="" />
                        <img className="mr-2" src="https://cdn-icons-png.flaticon.com/128/4494/4494485.png" alt="" />
                    </div>
