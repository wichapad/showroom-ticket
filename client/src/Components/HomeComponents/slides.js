...
const Slide = () => {
  return (
    <div className="slide-bg-image flex flex-col items-center md:flex-col lg:flex-row ">
      <Swiper
        effect={"cube"}
        grabCursor={true}
        cubeEffect={{
      ...
      <div className=" grid w-full grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-2 mx-4 ">
        {/* item 1 */}
